...
public interface TicketService {
	...
	Page<Ticket> findByCurrentUser(int page, int count, String currentUserId);
	
	Page<Ticket> findByParameters(int page, int count, String title, String status, String priority);
	
	Page<Ticket> findByParametersCurrentUser(int page, int count, String title, String status, String priority, String currentUserId);
